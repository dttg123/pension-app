/* 개인연금 V2.9.1 연금 코치·OCR */

/* ===== js/90-coach-ocr.js ===== */
(()=>{
'use strict';
const V12_VERSION='2.9.1';
...
state.meta=state.meta||{};state.meta.appVersion=V12_VERSION;state.meta.coachEngine=V12_ENGINE;v12StripTransient(state);document.title='개인연금 V2.9.1';renderAll(true);save();
})();
