...
state.meta=state.meta||{};state.meta.appVersion=V12_VERSION;state.meta.coachEngine=V12_ENGINE;v12StripTransient(state);document.title='개인연금 V2.1';renderAll(true);save();
})();
