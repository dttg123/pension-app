...
closeSheet=function(id,fromPop=false){oldCloseRelease(id,fromPop);if(id==='formSheet'&&ocrObjectUrl){URL.revokeObjectURL(ocrObjectUrl);ocrObjectUrl=null;ocrFile=null;document.getElementById('ocrViewer')?.classList.remove('open');window.syncModalState?.()}};
