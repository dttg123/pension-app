...
(()=>{
'use strict';
const V1_APP_VERSION='2.6.0';
const V1_SCHEMA_VERSION=6;
const V1_BACKUP_FORMAT='1.1';
const V1_PROJECT_BACKUP_FORMAT='1.0';
const V1_PROJECT_ASSETS=['index.html','base.css','components.css','features.css','v21.css','core.js','ui.js','analysis.js','ocr.js','backup.js','planning.js','ledger.js','coach.js','integrity.js','charts.js','v21.js','manifest.webmanifest','sw.js','icon.svg'];
...
window.PensionV1Record={
  ...
  snapshot(reason='asset-update',effectiveDate=''){
    /* V2.6: 종목별 상세 스냅샷은 누적하지 않는다. 최신 보유자산은 현재 상태로 유지하고,
